...
| Wave 2 - Core Modernization | baseline | Include integration refactoring as a contained modernization workstream. |
...
|-------------|------------|-----------|-----------|-----------------|------------------------|----------------|--------|----------|
| baseline | baseline | [photo-album](repos/baseline/report.md) | Java 8, Spring Boot 2.7.x | Azure Kubernetes Service | Upgrade to Java 25, Upgrade to Spring Boot 4.0 | 3/6/1 | L | Blocked |
